...
</header><form action="update.php" method="post">
<table align="center">
<tr><td colspan="3" align="center"><h2>Edit Profil</h2></td></tr>
<tr><td>Nama</td><td>
...
<?php } ?></td></tr>
<tr><td>NIM</td>
<td><input type="text" value="<?php echo $row["nim"] ?>" disabled></td>
</tr>
<tr><td>Kelas</td>
<td><input type="radio" name="kelas" value="1" <?php if($row["kelas"] == 1):echo "checked"; endif ?>>01
...
<input type="radio" name="kelas" value="4" <?php if($row["kelas"] == 4):echo "checked"; endif ?>>04</td></tr>
<tr><td>Jenis Kelamin</td>
<td><input type="radio" name="jk" value="laki-laki" <?php if($row["jk"] == "laki-laki"):echo "checked"; endif ?>>Laki-laki
<input type="radio" name="jk" value="perempuan" <?php if($row["jk"] == "perempuan"):echo "checked"; endif ?>>Perempuan
</td>
</tr>
<tr><td>Hobi</td>
<?php $hobi = explode(",",$row["hobi"]); ?>
<td><input type="checkbox" name="hobi[]" value="Olahraga" <?php if(in_array("Olahraga",$hobi)):echo "checked"; endif ?>>Olahraga
...
<input type="checkbox" name="hobi[]" value="Berkomedi" <?php if(in_array("Berkomedi",$hobi)):echo "checked"; endif ?>>Berkomedi<br></td></tr>
<tr><td>Fakultas</td><td>
<select name="fak"><option <?php if($row["fakultas"] == "Ilmu Terapan"):echo "selected";endif ?>>Ilmu Terapan</option>
<option <?php if($row["fakultas"] == "Informatika"):echo "selected";endif ?>>Informatika</option>
<option <?php if($row["fakultas"] == "Teknik Elektro"):echo "selected";endif ?>>Teknik Elektro</option></select></td></tr>
<tr><td>Alamat</td>
<td><textarea name="alamat" id="" cols="26" rows="1"><?php echo $row["alamat"] ?></textarea></td></tr>
<tr><input type="hidden" name="nim" value="<?php echo $row["nim"] ?>">
