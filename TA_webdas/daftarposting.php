...
<!DOCTYPE html>
<html lang="en">
<head><title>Daftar Post</title></head>
<body><header>
<table align="center">
...
<a href="logout.php">Logout</a></td></table></header>
<table align="center" border=1 cellpadding="6">
<tr><td>Judul</td><td>Isi</td><td>Gambar</td><td>Aksi</td></tr>
<?php 
if (mysqli_num_rows($result) > 0) {
while($row = mysqli_fetch_assoc($result)) {       
?>
<tr><td><b><?php echo $row["judul"] ?></b></td>
...
<?php $id = $row["id"] ?>
<td><a href="posting_update.php?post_id=<?php echo $id ?>">Edit</a> | 
<a href="delete.php?post_id=<?php echo $id ?>">Delete</a></td></tr>
<?php
}
}
?>
